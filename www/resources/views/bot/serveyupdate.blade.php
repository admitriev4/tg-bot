...
<div class="wrapper main-container">
    <div class="send-message">
        ...
        <form action="/servey/update/{{$id}}" method="post" enctype="multipart/form-data">
            ...
            <span><input name="active" type="checkbox" id="active" placeholder="Активность" @if($servey->active == "Y") checked @endif><label for="active">Активность</label></span>
            <span>Вопрос </span><input name="question" type="text"  maxlength="50" value="{{$servey->question}}">
